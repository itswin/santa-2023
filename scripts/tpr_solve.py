...
# seq 160 160 | xargs -I {} sh -c "python3 scripts/tpr_solve.py {} && python3 scripts/group_theory.py {} && scripts/k_moves.py {}"
...
directory = "/Users/Win33/Documents/Programming/TPR-4x4x4-Solver/"
SOLVER_PATH = "java -cp .:threephase.jar:twophase.jar solver".split()
cmd = SOLVER_PATH + [cubestring]
...
if num_difference <= wildcards:
    ...
    if len(mapped_sol) < len(current_solution) or True:
